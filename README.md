...
>
> 每个专家都是**有血有肉的人物档案**，包含核心立场、经典理论、发言风格、模拟发言、批评争议，
> 在圆桌讨论中能发出独特的、有锋芒的声音。
...
| 7 | [丹尼尔·卡尼曼](experts/psychology/daniel-kahneman.md) | 心理学 | 双系统思维、前景理论、启发式与认知偏差、框架效应、体验自我vs记忆自我、噪声 | 8 | ✅ | ⏳ |
| 8 | [菲利普·津巴多](experts/psychology/philip-zimbardo.md) | 心理学 | 斯坦福监狱实验、路西法效应、去个人化、英雄想象项目、时间观理论 | 8 | ✅ | ⏳ |
| 9 | [马丁·塞利格曼](experts/psychology/martin-seligman.md) | 心理学 | 习得性无助、习得性乐观、PERMA模型、突出优势理论、积极心理学宣言 | 8 | ✅ | ⏳ |
...
| 等级 | 名称 | 内容 | 检查方式 |
|:---|:---|:---|:---|
| L1 | 信息完整度 | 8项指标全部达标，量化评分（满分100） | 自动检查 |
| L2 | 仿真发言测试 | 给定话题，评估发言是否"像本人"（4维度×25分） | 模拟测试 |
...
| 规则 | 说明 |
|:---|:---|
| 事实必须有来源 | 每个事实必须有至少1个搜索来源支撑 |
| 无法验证则标注 | 无法验证的信息标注 `[待核实]` |
| MBTI需谨慎 | 历史人物MBTI标注 `[推测]` 并说明依据 |
| 语录需出处 | 无出处的语录标注 `[出处待查]` |
| 搜索来源URL化 | 所有来源必须包含可点击的URL链接 |
...
├── templates/
│   ├── expert-profile-template.md     ← 通用档案模板
│   ├── expert-profile-science.md      ← 科学家模板变体
│   ├── expert-profile-philosophy.md   ← 哲学家模板变体
│   └── expert-profile-cross-domain.md ← 跨界专家模板变体
└── experts/
    ├── business/          ← 商业管理专家
    ├── psychology/        ← 心理学专家
    ├── philosophy/        ← 文学哲学专家
